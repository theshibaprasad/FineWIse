...
export async function registerPhoneToSandbox(phoneNumber) {
  try {
    ...
    console.log('Registering phone number to Twilio sandbox:', cleanPhone);
    ...
    console.log('Successfully registered phone number to sandbox:', cleanPhone);
    return true;
  } catch (error) {
...
export async function sendWelcomeMessage(phoneNumber, userName) {
  try {
    ...
    console.log('Welcome message sent to:', cleanPhone);
    return true;
  } catch (error) {
